...
Only repository masters (currently: [Freeman Kuguyo](https://github.com/francis-pouatcha) )
...
### Contributing
Any person implementing some parts of code or fixing some bugs and making a merge requests for them must adhere to the conditions listed in the Definition of Done are required to be fulfilled in any case.
