...
@Builder
@ToString
public class GupshupImageMessage implements GupshupMessage
{
	...
	{
		private final String type = GupshupMessageTypes.IMAGE.toString().toLowerCase();
		@NotBlank(message = "please enter the gupshup image url")
