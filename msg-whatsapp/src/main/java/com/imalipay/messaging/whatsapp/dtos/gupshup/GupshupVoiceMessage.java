...
@Builder
@ToString
public class GupshupVoiceMessage implements GupshupMessage
{
	...
	{
		private final String type = GupshupMessageTypes.AUDIO.toString().toLowerCase();
		@NotBlank(message = "please enter the gupshup voice url")
		private String url;
	}
}
